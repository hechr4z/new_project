  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <div class="content-header">
        ...
        <a class="btn btn-success text-light mx-4" href="/create">TAMBAH BARANG</a>
        <a class="btn btn-warning text-light" href="/print">CETAK LAPORAN</a>
      </div>
        ...
        <table class="table text-center table-dark">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <form action="/delete/{{ $datas->Kd_Barang }}" method="POST">
                  <a class="btn btn-primary text-light" href="/update/{{ $datas->Kd_Barang }}">UPDATE</a>
                  @csrf
                  @method('DELETE')
