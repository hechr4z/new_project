    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <h5 class="mx-4">DATA STOK BARANG - CETAK LAPORAN</h5>
            </div>

            <div class="container">
                <a class="btn btn-danger text-light my-2" href="/dashboard-admin">BACK</a>
                <form action="/print-process" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>Tanggal Awal</label>
                            <input type="datetime-local" class="form-control" name="Tanggal_Awal" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            <label>Tanggal Akhir</label>
                            <input type="datetime-local" class="form-control" name="Tanggal_Akhir" autocomplete="off">
                        </div>
                    </div>
                    <button type="submit" class="btn btn-warning text-light">PRINT</button>
                </form>
            </div>
        </div>
